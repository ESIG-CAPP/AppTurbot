Public Class FrmClientTicket
    ...
    Private Sub FrmClientTicket_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        APP_TicketBindingSource.Filter = "TicketUtilisateurID = '" & userID & "'"
    End Sub
